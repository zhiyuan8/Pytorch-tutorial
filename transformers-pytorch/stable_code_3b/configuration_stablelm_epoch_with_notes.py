...
class StableLMEpochConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        rope_pct=0.25,
        rope_theta=10_000,
        max_position_embeddings=4096,     # For positional embedding! Not the max sequence length
        ...
        **kwargs,
        ...
        # Whether to share the embedding weights layer and the final linear layer!
